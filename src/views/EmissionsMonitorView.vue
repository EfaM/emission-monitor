          ...
          <div class="row g-4 my-4">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card text-start text-md-center">
                ...
                />
                <div class="card-body">
                  <h5 class="card-title">{{ t('Emission.card1') }}</h5>
                  <p class="card-text">
                    {{ t('Emission.card1corp') }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card text-start text-md-center">
                <img
                  ...
                  class="card-img-top p-4"
                  alt="Schmuckbild: Scope 3 Emissionen. Emissionen durch Wertschöpfungsketten"
                />
                <div class="card-body">
                  <h5 class="card-title">{{ t('Emission.card3') }}</h5>
                  <p class="card-text">
                    {{ t('Emission.liefGeschNu') }}
                  </p>
                </div>
              </div>
            </div>
